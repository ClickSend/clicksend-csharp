...
${nuget_cmd} install src/IO.ClickSend/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/IO.ClickSend.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/IO.ClickSend.dll \
-recurse:'src/IO.ClickSend/*.cs' \
-doc:bin/IO.ClickSend.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/IO.ClickSend.dll was created successfully"
fi
