...
namespace IO.ClickSend.ClickSend.Api
{
        ...
        public interface IUploadApi : IApiAccessor
    {
        ...
        ApiResponse<string> UploadsPostWithHttpInfo (UploadFile body, string convert);
        ...
        System.Threading.Tasks.Task<string> UploadsPostAsync (UploadFile body, string convert);
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> UploadsPostAsyncWithHttpInfo (UploadFile body, string convert);
        ...
        public partial class UploadApi : IUploadApi
    {
        ...
        /// <param name="convert"></param>
        /// <returns>string</returns>
        public string UploadsPost (UploadFile body, string convert)
        {
             ApiResponse<string> localVarResponse = UploadsPostWithHttpInfo(body, convert);
        ...
        /// <param name="convert"></param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > UploadsPostWithHttpInfo (UploadFile body, string convert)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling UploadApi->UploadsPost");
        ...
        /// <param name="convert"></param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> UploadsPostAsync (UploadFile body, string convert)
        {
             ApiResponse<string> localVarResponse = await UploadsPostAsyncWithHttpInfo(body, convert);
             return localVarResponse.Data;
        ...
        /// <param name="convert"></param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> UploadsPostAsyncWithHttpInfo (UploadFile body, string convert)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling UploadApi->UploadsPost");
