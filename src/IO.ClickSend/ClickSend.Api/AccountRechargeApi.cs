...
namespace IO.ClickSend.ClickSend.Api
{
        ...
        public interface IAccountRechargeApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="IO.ClickSend.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">CreditCard model</param>
        /// <returns>string</returns>
        ...
        /// <param name="body">CreditCard model</param>
        /// <returns>ApiResponse of string</returns>
        ApiResponse<string> RechargeCreditCardPutWithHttpInfo (CreditCard body);
        /// <summary>
        ...
        /// <param name="body">CreditCard model</param>
        /// <returns>Task of string</returns>
        System.Threading.Tasks.Task<string> RechargeCreditCardPutAsync (CreditCard body);
        ...
        /// <param name="body">CreditCard model</param>
        /// <returns>Task of ApiResponse (string)</returns>
        System.Threading.Tasks.Task<ApiResponse<string>> RechargeCreditCardPutAsyncWithHttpInfo (CreditCard body);
        /// <summary>
        /// Get list of all packages
        /// </summary>
        /// <remarks>
        ...
        public partial class AccountRechargeApi : IAccountRechargeApi
    {
        ...
        /// <param name="body">CreditCard model</param>
        /// <returns>string</returns>
        public string RechargeCreditCardPut (CreditCard body)
        {
             ApiResponse<string> localVarResponse = RechargeCreditCardPutWithHttpInfo(body);
             return localVarResponse.Data;
        }
        ...
        /// <param name="body">CreditCard model</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > RechargeCreditCardPutWithHttpInfo (CreditCard body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AccountRechargeApi->RechargeCreditCardPut");
        ...
        /// <param name="body">CreditCard model</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> RechargeCreditCardPutAsync (CreditCard body)
        {
             ApiResponse<string> localVarResponse = await RechargeCreditCardPutAsyncWithHttpInfo(body);
             return localVarResponse.Data;
        ...
        /// <param name="body">CreditCard model</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> RechargeCreditCardPutAsyncWithHttpInfo (CreditCard body)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling AccountRechargeApi->RechargeCreditCardPut");
