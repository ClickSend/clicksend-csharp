...
namespace IO.ClickSend.ClickSend.Api
{
        ...
        public interface IContactApi : IApiAccessor
    {
        ...
        /// <param name="contactId">Contact ID</param>
        /// <returns>ApiResponse of string</returns>
        ApiResponse<string> ListsContactsByListIdAndContactIdPutWithHttpInfo (Contact body, int? listId, int? contactId);
        /// <summary>
        ...
        /// <param name="listId">List id</param>
        /// <returns>ApiResponse of string</returns>
        ApiResponse<string> ListsContactsByListIdPostWithHttpInfo (Contact body, int? listId);
        /// <summary>
        ...
        /// <param name="contactId">Contact ID</param>
        /// <returns>Task of string</returns>
        System.Threading.Tasks.Task<string> ListsContactsByListIdAndContactIdPutAsync (Contact body, int? listId, int? contactId);
        ...
        /// <param name="contactId">Contact ID</param>
        /// <returns>Task of ApiResponse (string)</returns>
        System.Threading.Tasks.Task<ApiResponse<string>> ListsContactsByListIdAndContactIdPutAsyncWithHttpInfo (Contact body, int? listId, int? contactId);
        /// <summary>
        /// Get all contacts in a list
        /// </summary>
        /// <remarks>
        ...
        /// <param name="listId">List id</param>
        /// <returns>Task of string</returns>
        System.Threading.Tasks.Task<string> ListsContactsByListIdPostAsync (Contact body, int? listId);
        ...
        /// <param name="listId">List id</param>
        /// <returns>Task of ApiResponse (string)</returns>
        System.Threading.Tasks.Task<ApiResponse<string>> ListsContactsByListIdPostAsyncWithHttpInfo (Contact body, int? listId);
        /// <summary>
        /// Copy contact to another list
        /// </summary>
        /// <remarks>
        ...
        public partial class ContactApi : IContactApi
    {
        ...
        /// <param name="contactId">Contact ID</param>
        /// <returns>string</returns>
        public string ListsContactsByListIdAndContactIdPut (Contact body, int? listId, int? contactId)
        {
             ApiResponse<string> localVarResponse = ListsContactsByListIdAndContactIdPutWithHttpInfo(body, listId, contactId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="contactId">Contact ID</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > ListsContactsByListIdAndContactIdPutWithHttpInfo (Contact body, int? listId, int? contactId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContactApi->ListsContactsByListIdAndContactIdPut");
            // verify the required parameter 'listId' is set
            if (listId == null)
        ...
        /// <param name="contactId">Contact ID</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> ListsContactsByListIdAndContactIdPutAsync (Contact body, int? listId, int? contactId)
        {
             ApiResponse<string> localVarResponse = await ListsContactsByListIdAndContactIdPutAsyncWithHttpInfo(body, listId, contactId);
             return localVarResponse.Data;
        ...
        /// <param name="contactId">Contact ID</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> ListsContactsByListIdAndContactIdPutAsyncWithHttpInfo (Contact body, int? listId, int? contactId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContactApi->ListsContactsByListIdAndContactIdPut");
        ...
        /// <param name="listId">List id</param>
        /// <returns>string</returns>
        public string ListsContactsByListIdPost (Contact body, int? listId)
        {
             ApiResponse<string> localVarResponse = ListsContactsByListIdPostWithHttpInfo(body, listId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="listId">List id</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > ListsContactsByListIdPostWithHttpInfo (Contact body, int? listId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContactApi->ListsContactsByListIdPost");
            // verify the required parameter 'listId' is set
            if (listId == null)
        ...
        /// <param name="listId">List id</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> ListsContactsByListIdPostAsync (Contact body, int? listId)
        {
             ApiResponse<string> localVarResponse = await ListsContactsByListIdPostAsyncWithHttpInfo(body, listId);
             return localVarResponse.Data;
        ...
        /// <param name="listId">List id</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> ListsContactsByListIdPostAsyncWithHttpInfo (Contact body, int? listId)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling ContactApi->ListsContactsByListIdPost");
