...
namespace IO.ClickSend.ClickSend.Api
{
    ...
    public interface IDetectAddressApi : IApiAccessor
    {
        ...
        ApiResponse<string> DetectAddressPostWithHttpInfo (Content content);
        ...
        System.Threading.Tasks.Task<string> DetectAddressPostAsync (Content content);
        ...
        System.Threading.Tasks.Task<ApiResponse<string>> DetectAddressPostAsyncWithHttpInfo (Content content);
    ...
    public partial class DetectAddressApi : IDetectAddressApi
    {
        ...
        /// <param name="content">Your file to be uploaded</param>
        /// <returns>string</returns>
        public string DetectAddressPost (Content content)
        {
        ...
        /// <param name="content">Your file to be uploaded</param>
        /// <returns>ApiResponse of string</returns>
        public ApiResponse< string > DetectAddressPostWithHttpInfo (Content content)
        {
        ...
        /// <param name="content">Your file to be uploaded</param>
        /// <returns>Task of string</returns>
        public async System.Threading.Tasks.Task<string> DetectAddressPostAsync (Content content)
        {
        ...
        /// <param name="content">Your file to be uploaded</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<string>> DetectAddressPostAsyncWithHttpInfo (Content content)
        {
            // verify the required parameter 'content' is set
            if (content == null)
                throw new ApiException(400, "Missing required parameter 'content' when calling DetectAddressApi->DetectAddressPost");
