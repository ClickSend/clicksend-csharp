...
namespace IO.Swagger.ClickSend.Model
{
    ...
    public partial class Contact :  IEquatable<Contact>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Contact" /> class.
        /// </summary>
        /// <param name="phoneNumber">Your phone number in E.164 format. Must be provided if no fax number or email. (required).</param>
        /// <param name="custom1">custom1 (required).</param>
        ...
        public Contact(string phoneNumber = default(string), string custom1 = default(string), string email = default(string), string faxNumber = default(string), string firstName = default(string), string addressLine1 = default(string), string addressLine2 = default(string), string addressCity = default(string), string addressState = default(string), string addressPostalCode = default(string), string addressCountry = default(string), string organizationName = default(string), string custom2 = default(string), string custom3 = default(string), string custom4 = default(string), string lastName = default(string))
        {
            // to ensure "phoneNumber" is required (not null)
            if (phoneNumber == null)
            {
                throw new InvalidDataException("phoneNumber is a required property for Contact and cannot be null");
            }
            else
            {
                this.PhoneNumber = phoneNumber;
            }
            // to ensure "custom1" is required (not null)
            if (custom1 == null)
            {
                throw new InvalidDataException("custom1 is a required property for Contact and cannot be null");
            }
            else
            {
