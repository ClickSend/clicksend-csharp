...
namespace IO.ClickSend.Test
{
    ...
    public class VoiceApiTests
    {
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //VoiceMessageCollection body = null;
            //var response = instance.VoicePricePost(body);
            //Assert.IsInstanceOf<string> (response, "response is string");
        }
        /// <summary>
        ...
        public void VoiceReceiptsPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //Url body = null;
            //var response = instance.VoiceReceiptsPost(body);
            //Assert.IsInstanceOf<string> (response, "response is string");
        }
        /// <summary>
        ...
        public void VoiceReceiptsReadPutTest()
        {
            ...
            //var response = instance.VoiceReceiptsReadPut(body);
            //Assert.IsInstanceOf<string> (response, "response is string");
        }
        /// <summary>
        /// Test VoiceSendPost
        ...
        public void VoiceSendPostTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //VoiceMessageCollection body = null;
            //var response = instance.VoiceSendPost(body);
            //Assert.IsInstanceOf<string> (response, "response is string");
        }
    }
