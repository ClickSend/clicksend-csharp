...
namespace IO.ClickSend.Test
{
    ...
    public class UserEmailTemplatesApiTests
    {
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //EmailTemplateNew body = null;
            //var response = instance.EmailTemplatePost(body);
            //Assert.IsInstanceOf<string> (response, "response is string");
        }
        /// <summary>
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //EmailTemplateUpdate body = null;
            //int? templateId = null;
            //var response = instance.EmailTemplatePut(body, templateId);
            //Assert.IsInstanceOf<string> (response, "response is string");
        }
        /// <summary>
