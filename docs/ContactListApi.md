...
# **ListsByListIdPut**
> string ListsByListIdPut (int? listId, string listName)
...
namespace Example
{
    public class ListsByListIdPutExample
    {
        public void main()
        {
            ...
            var listName = listName_example;  // string | Your new list name
...
<a name="listspost"></a>
# **ListsPost**
> string ListsPost (string listName)
...
namespace Example
{
    public class ListsPostExample
    {
        public void main()
        {
            ...
            var apiInstance = new ContactListApi();
            var listName = listName_example;  // string | Your contact list name
